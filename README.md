...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .btn-whatsapp{background:#25D366;color:#04260f;box-shadow:0 6px 18px rgba(37,211,102,0.12);border:0}
...
<body>
      ...
      <div id="pageDashboard" class="card hidden">
        ...
        <div class="grid cols-2 spaced">
          ...
          <aside class="card sidebar" id="sidebarRight" style="padding:12px">
            ...
            <div class="spaced small-muted">Contactez le support via l'email associé à votre compte ou depuis votre tableau de bord.</div>
          </aside>
        </div>
      </div>
  ...
  { q: "La chaîne de l’ADN monte de :", r: ["3,4 Å par base", "34 Å par tour", "1 nm par base", "2,4 nm de diamètre"], c: ["A","B","D"] }
      ...
      function renderNav(){
        ...
        // WhatsApp join button (always shown)
        const waBtn = el('a','Rejoindre la chaîne WhatsApp', { class:'btn btn-whatsapp', href:WHATSAPP_CHANNEL, target:'_blank', rel:'noopener noreferrer', 'aria-label':'Rejoindre la chaîne WhatsApp pour les nouveautés' });
